...
const CreateResource = () => {
    ...
    const handleSubmit = () => {
        if (title === null || category === null || website === null || contact === null || phone === null) {
            ...
            fetch("https://bfts-backend.herokuapp.com/resources/create", requestOptions).then(async (response) => {
			...
			<TouchableWithoutFeedback onPress={Keyboard.dismiss}>
				<ScrollView>
                    <View style={{ marginTop: "20%", alignItems:'center', padding: 5 }}>
                        <Text style={{ fontFamily: 'Montserrat_500Medium', fontSize: 30 }}>
                            Create a Resource
                        </Text>
                    </View>
                    ...
                    <View style={{ justifyContent: 'center', alignItems: 'center', marginTop: 40, padding: 10 }}>
                        ...
                        style={{ backgroundColor: BFTS_BLUE, width: 225, height: 65, borderRadius: 10, alignContent: 'center', justifyContent: 'center', alignItems: 'center' }}>
