...
const Profile = () => {
	return (
		<View style={{backgroundColor: 'white', height: '100%', alignItems: 'center', padding: 10, flex: 1}}>
			...
			<View style={{width: "100%", marginTop: 15, flexDirection: 'row', alignContent: 'space-between', justifyContent: 'center'}}>
			...
			<View style={{width: '100%', alignContent: 'center', alignItems: 'center'}}>
				<View style={profileStyles.clientHeader}>
					<Text style={{fontFamily: 'Montserrat_700Bold', color: 'black', fontSize: '20', padding: 7}}>Clients</Text>
				</View>
				<ScrollView style={{width: '100%', height: "67%"}}>
					{profiles.map((profile, id) => <View style={{width: '100%', justifyContent: 'center', alignItems: 'center', marginTop: 10}}><ProfileCard key={id} profile={profile}/></View>)}
				</ScrollView>
			</View>
		</View>
	);
